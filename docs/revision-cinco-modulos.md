...
| 7.2 Salida segura · rebanada 2 (la puerta) | **PENDIENTE** | — | falta el token/QR por autorizado, la pantalla del guardia, `salidas_alumno` (registro de entrega) y el aviso a responsables | QR validado en servidor sobre el estado actual; registro con quién/cuándo/cómo | QR reusado sobre estado cambiado se rechaza |
