...
export const CATALOGO_MENU: GrupoMenu[] = [
    ...
    {
        /*
         * «Mis formularios». Sólo para el padre de familia y el tutor
        ...
        etiqueta: 'Mis formularios',
        prefijo: '/mis-formularios',
        ...
        hijos: [{ clave: 'mis-formularios-listado', etiqueta: 'Mis formularios', url: '/mis-formularios' }],
    },
    {
        clave: 'mis-hijos',
        etiqueta: 'Mis hijos',
