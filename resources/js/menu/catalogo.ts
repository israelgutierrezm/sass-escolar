...
export const CATALOGO_MENU: GrupoMenu[] = [
    {
        ...
        hijos: [{ clave: 'panel-inicio', etiqueta: 'Panel', url: '/panel', permiso: null }],
    },
    {
        clave: 'portal',
    ...
    },
    {
        ...
        hijos: [
            ...
            { clave: 'inscripciones', etiqueta: 'Inscripciones', url: '/escolar/inscripciones', permiso: 'inscribir-alumnos' },
        ],
    },
    {
        clave: 'docentes',
