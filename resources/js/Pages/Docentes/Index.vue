...
const props = defineProps<{
    ...
    filtros: { busqueda: string; situacion_id: number | null; tipo_docente_id: number | null; campus_id: number | null };
...
const tipoId = ref(props.filtros.tipo_docente_id);
...
watch([situacionId, tipoId, campusId], consultar);
...
function consultar(): void {
    router.get(
        '/escolar/docentes',
        {
            ...
            tipo_docente_id: tipoId.value || undefined,
...
<template>
    ...
    <AppLayout titulo="Docentes">
        ...
        <section class="tarjeta overflow-hidden">
            ...
            <nav v-if="docentes.links.length > 3" class="flex flex-wrap gap-1 border-t px-6 py-3" :style="{ borderColor: 'var(--color-borde)' }">
                <component
                    :is="enlace.url ? 'a' : 'span'"
                    v-for="enlace in docentes.links"
                    :key="enlace.label"
