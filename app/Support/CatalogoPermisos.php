...
final class CatalogoPermisos
{
    ...
    private const CATALOGO = [
        ...
        'Finanzas' => [
            ...
            'gestionar-proveedores' => ['Administrar proveedores', 'El catálogo de a quién se le compra: nombre, RFC, contacto. Estructura el beneficiario de los egresos y es la base de las cuentas por pagar.', [self::ADMINISTRATIVO]],
            'gestionar-cuentas-pagar' => ['Registrar cuentas por pagar', 'Capturar y corregir lo que la escuela le debe a un proveedor, con su vencimiento. Va aparte de pagarlas: quien registra la obligación no es quien autoriza el pago.', [self::ADMINISTRATIVO]],
            'pagar-proveedores' => ['Pagar a proveedores', 'Registrar el pago de una cuenta por pagar. El pago se asienta como un egreso —ahí el dinero sale y consume presupuesto—, así que va aparte de registrar la obligación.', [self::ADMINISTRATIVO]],
            'gestionar-ordenes-compra' => ['Gestionar órdenes de compra', 'Armar y recibir órdenes de compra. Recibir una genera su cuenta por pagar. Autorizarlas va aparte: quien pide no es quien aprueba el gasto.', [self::ADMINISTRATIVO]],
            'autorizar-ordenes-compra' => ['Autorizar órdenes de compra', 'Aprobar una orden de compra, que la vuelve un compromiso. Va aparte de armarla: es la firma que autoriza el gasto.', [self::ADMINISTRATIVO]],
